...
<div class="container mt-4">
  <div class="row mt-3">
    <div class="col-12">
      <h5 class="text-center mb-3">Create a New Meal</h5>
    </div>
  ...
  <div class="container">
    <form class="forms" action="a_newmeal.php?user_id=<?php echo $user_id ?>" method="post" autocomplete="off">
      <label for="inputName">Name</label>
      <input type="text" id="inputName" class="form-control" placeholder="Enter a name for the meal . . ." name="name" required autofocus>
      <hr>
      <h6>Ingredients to Purchase</h6><br>
      <div class="form-group">
        <input type="text" id="inputIngredient" class="form-control" placeholder="Enter an Ingredient" name="ing1" required>
        <div class="row mt-2">
          <div class="col-3 mr-0 pr-0">
            <input type="number" class="form-control" id="inputAmount" name="unit1" step="0.01">
          </div>
          <label for="inputAmount" class="col-8 col-form-label">amount per person</label>
        </div>
      </div><br>
      <div class="form-group">
        <input type="text" id="inputIngredient" class="form-control" placeholder="Enter an Ingredient" name="ing2">
        <div class="row mt-2">
          <div class="col-3 mr-0 pr-0">
            <input type="number" class="form-control" id="inputAmount" name="unit2" step="0.01">
          </div>
          <label for="inputAmount" class="col-8 col-form-label">amount per person</label>
        </div>
      </div><br>
      <div class="form-group">
        <input type="text" id="inputIngredient" class="form-control" placeholder="Enter an Ingredient" name="ing3">
        <div class="row mt-2">
          <div class="col-3 mr-0 pr-0">
            <input type="number" class="form-control" id="inputAmount" name="unit3" step="0.01">
          </div>
          <label for="inputAmount" class="col-8 col-form-label">amount per person</label>
        </div>
      </div><br>
      <div class="form-group">
        <input type="text" id="inputIngredient" class="form-control" placeholder="Enter an Ingredient" name="ing4">
        <div class="row mt-2">
          <div class="col-3 mr-0 pr-0">
            <input type="number" class="form-control" id="inputAmount" name="unit4" step="0.01">
          </div>
          <label for="inputAmount" class="col-8 col-form-label">amount per person</label>
        </div>
      </div>
